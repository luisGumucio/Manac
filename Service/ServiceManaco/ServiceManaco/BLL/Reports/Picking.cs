...
namespace Bata.Aquarella.BLL.Reports
{
    public class Picking
    {
        ...
        public DateTime _dateExpi { get; set; }
        ...
        string cusDoc, string cusName, string cusAdd, string cusPhone, string cusCellPhone, string cusMail, string cusUbication, DateTime dateExpi,
            string liqNo, string liqStatus, string artCode, string artBrand, string artColor, string artName,
            string artSize, decimal artQty, decimal price, decimal disc,
            string storage, string op, string empPick, string inst)
        {
            _wavId = wavId;
            _wavDes = wavDes;
            _wavAdd = wavAdd;
